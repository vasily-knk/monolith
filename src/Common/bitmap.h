...
#define BMPERR_OK				0
#define BMPERR_FILE_NOT_FOUND	1
#define BMPERR_UNSUPPORTED		2
#define BMPERR_UNSUPPORTED_YET	3
#define BMPERR_ALLOC_FAILED		4
#define BMPERR_DATA_EMPTY		5
...
public:
	...
	int GetError () {return error; error=0;}
public:
...
public:
	...
	v_uint8* ptr;
private:
	void SetError (int e) {if (!error) error=e;}
	int error;
};
